        ...
        <div class="row">
            ...
            <div class="col-lg-6 d-flex flex-column justify-content-center"> 
                <div class="form-box d-flex flex-row justify-content-center">
                    <div>
                    <form action="book_product.php?product=vivo" method="post">
                        <input type="number" name="mobileNumber" id="mobileNumber" placeholder="Enter Alternative Mobile Number"><br><hr>
                        <p>Address Details:</p>
                        ...
                        <input type="number" name="pin" id="pin" minlength="6" maxlength="6" required placeholder="PIN"><br><br>
                        <input type="text" name="state" id="state" placeholder="State"><br><br>
                        <button type="submit" class="btn btn-info">Place Order</button>
                        <br><br>
                    </form>
                    <a href="mainpage.html" ><button class="btn btn-warning text-white">Do Not Order</button></a>
                    </div>
            </div>
